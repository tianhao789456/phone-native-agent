...
object NativeAgentProfile {
    ...
    val systemPrompt: String =
        "Prompt version: $SYSTEM_PROMPT_VERSION. " +
            ...
            "For repeated tasks, phone-control tasks, desktop/MCP tasks, terminal tasks, and user-specific questions, inspect relevant procedure first, then experience, then memory before acting when baseline memory tools are available. After tool-based tasks, record durable user facts and reusable success/failure lessons with memory or experience tools when useful. Do not store secrets verbatim. " +
